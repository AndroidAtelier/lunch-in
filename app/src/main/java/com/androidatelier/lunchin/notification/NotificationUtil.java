...
public abstract class NotificationUtil  {
  ...
  public static final String ACTION_LUNCH_OUT
      = "com.androidatelier.lunchin.notification.ACTION_LUNCH_OUT";
  public static final String ACTION_LUNCH_IN
      = "com.androidatelier.lunchin.notification.ACTION_LUNCH_IN";
  public static final String ACTION_DISMISS
      = "com.androidatelier.lunchin.notification.ACTION_DISMISS";
  ...
  private static Notification.Builder getLunchNotification(
    ...
    Intent noIntent = new Intent(context, com.androidatelier.lunchin.notification.NotificationReceiver.class);
